...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { name: "Admin Dashboard", icon: <DashboardIcon />, path: "/admin/dashboard" },
    { name: "Manage Users", icon: <UsersIcon />, path: "/admin/dashboard/users" },
    { name: "Manage Meals", icon: <MealIcon />, path: "/admin/dashboard/meals" },
    { name: "Settings", icon: <SettingsIcon />, path: "/admin/dashboard/settings" }
  ];
  ...
  return (
    <div className="d-flex vh-100 overflow-hidden">
      ...
      <div
        ...
        style={{
          width: '240px',
          background: 'linear-gradient(to bottom, #35a85cff, #3a9ca3ff)'
        }}
      >
      ...
      <div className="d-flex flex-column flex-grow-1 bg-light">
        ...
        >
          <h3 className="m-0 text-purple fw-semibold">.</h3>
